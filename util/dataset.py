...
class SeaLionPatchDataset:
    ...
    def _prepare_patches(self):
        for filename in self.image_files:
            ...
            img1_scaled = cv2.GaussianBlur(image_1_scaled, (5, 5), 0)
            img2_scaled = cv2.GaussianBlur(image_2_scaled, (5, 5), 0)

            # 將 blob 坐標映射到縮放後的坐標系
            blobs_scaled = [(y * self.scale_factor, x * self.scale_factor, s) for y, x, s in blobs]
